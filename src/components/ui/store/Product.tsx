  ...
  return (
    <ProductPrimitive.ProductMediaGallery {...props} ref={ref}>
      {props.children ? (
        ...
        // Default media gallery structure if no children provided
        <>
          <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-secondary/80 to-secondary/60">
            <svg
